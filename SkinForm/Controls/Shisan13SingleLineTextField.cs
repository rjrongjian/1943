...
using YUNkefu.Animations;

namespace YUNkefu.Controls
{
    public class Shisan13SingleLineTextField : Control, IShisan13Control
    {
        //Properties for managing the Shisan13 design properties
        [Browsable(false)]
        ...
        public Shisan13SingleLineTextField()
        {
        ...
        private class BaseTextBox : TextBox
        {
            ...
            public BaseTextBox()
            {
                Shisan13ContextMenuStrip cms = new TextBoxContextMenuStrip();
        ...
        private class TextBoxContextMenuStrip : Shisan13ContextMenuStrip
        {
            public readonly ToolStripItem undo = new Shisan13ToolStripMenuItem { Text = "撤销" };
            public readonly ToolStripItem seperator1 = new ToolStripSeparator();
            public readonly ToolStripItem cut = new Shisan13ToolStripMenuItem { Text = "剪切" };
            public readonly ToolStripItem copy = new Shisan13ToolStripMenuItem { Text = "复制" };
            public readonly ToolStripItem paste = new Shisan13ToolStripMenuItem { Text = "粘贴" };
            public readonly ToolStripItem delete = new Shisan13ToolStripMenuItem { Text = "删除" };
            public readonly ToolStripItem seperator2 = new ToolStripSeparator();
            public readonly ToolStripItem selectAll = new Shisan13ToolStripMenuItem { Text = "全选" };
